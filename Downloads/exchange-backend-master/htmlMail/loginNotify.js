    ...
    <tr>
        <td colspan="2" align="center">
            <div style="padding-left: 15px; padding-right: 15px; padding-top: 15px; padding-bottom: 0px; color: #fff; margin-top: 5px;border-radius: 8px 8px 0 0;">
                <div style="padding-bottom: 15px; font-size: 26px; font-weight: bold; position: relative;"> You Have Signed In From A New Ip Address <span style="position: absolute; display: block; overflow: hidden; width: 114px; height: 5px; border-radius: 5px; bottom: 0; left: 50%; background-color: #34d1d6; transform: translateX(-50%);"></span>
                </div>
            </div>
        </td>
    </tr>
