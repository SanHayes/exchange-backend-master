...
module.exports = {
    ...
    walletTrans: (data, callback) => {
        ...
        //
        let receive = amount
        let sqlq = `update users set money_${mysql_real_escape_string(type_s)} = money_${mysql_real_escape_string(type_s)} - ?, money_${mysql_real_escape_string(type_r)} = money_${mysql_real_escape_string(type_r)} + ? where nick_name = ?`
