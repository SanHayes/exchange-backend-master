...
var TOKEN_KEY_Ether = 'X6P7HHXBKYX2G6DPY5BTKKIIMUU67F1JKV', TOKEN_KEY_Bsc = 'H4FGQW7MK3D4QSK6HB54GGQWB9B14UQ4GI',
    apiEther = null, apiBsc = null, web3 = null, web3Bsc = null;
...
function setConnectSmartChain(type) {
    ...
    if (!type) { // mainnet
        ...
        */
        ...
        web3 = new Web3(new Web3.providers.HttpProvider(`https://mainnet.infura.io/v3/${config.INFURA_PROJECT_ID}`))
        /* 
        ...
        */
        ...
        web3 = new Web3(new Web3.providers.HttpProvider(`https://rinkeby.infura.io/v3/${config.INFURA_PROJECT_ID}`))
        /* 
           Config BSC Scan BEP20
       */
...
module.exports = {
    ...
    sendCoinBSC: async (priceUSDT, AddressForUser, idHis) => {
        return await new Promise((resolve, reject) => {
            ...
            let dataSys = Helper.getConfig(fileSys);
            let addressFrom = dataSys.ADDRESS_ETH_TRANSACTION; // 管理员钱包地址
            let KeyFrom = dataSys.PRIVATE_KEY_ETH_TRANSACTION;
                        ...
                        try {
                            if (res2.status == 1) {
                                ...
                                if (price >= fee) { //0.00105 * 2 是最低费用
                                    ...
                                    let toAddressAdmin = AddressForUser; // 客户钱包
                                    ...
                                    web3Bsc.eth.getTransactionCount(addressFrom)
                                        .then((count) => {
                                            ...
                                            web3Bsc.eth.sendSignedTransaction(raw, (err, txHash) => {
                                                ...
                                                if (void 0 !== txHash) {
                                                    // 此合约的预估 gas 费用 Gas Used by Transaction
